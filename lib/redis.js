...
//
// Deque.prototype.shift = function shift() {
//   var head = this._head;
...
//   logSetGetTournamentsCommand('SHIFT', item);
//   return item;
// };
//
// /**
...
//  * @param item
//  */
// Deque.prototype.push = function push(item) {
//   if (item === undefined) return this.size();
//   logSetGetTournamentsCommand('PUSH', item.command);
//   var tail = this._tail;
